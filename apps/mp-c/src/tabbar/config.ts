 ...
 */
export enum TABBAR_STRATEGY_MAP {
  NO_TABBAR,
  NATIVE_TABBAR,
  CUSTOM_TABBAR_WITH_CACHE,
...
export const selectedTabbarStrategy: TABBAR_STRATEGY_MAP = TABBAR_STRATEGY_MAP.CUSTOM_TABBAR_WITH_CACHE
